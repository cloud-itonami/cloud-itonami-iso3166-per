# cloud-itonami-iso3166-per

Open ISO 3166 Blueprint for **PER**: Peru.
...
tax registration, and local-content rules in Peru, so the operator
...
- **Not the government of Peru.** See
...
- **Not legal or tax advice.** Every regulatory claim must cite the
  official source and route final filings to Peruvian-licensed counsel
...
(ISO 3166 `PER`). Required capabilities:
