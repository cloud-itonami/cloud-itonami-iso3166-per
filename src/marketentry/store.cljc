(ns marketentry.store
  "SSoT for the PER market-entry compliance actor, behind a `Store`
...
(defn demo-data
  ...
  []
  {:engagements
   {"eng-1" {:id "eng-1" :operator "Kita Systems PE" :portal "SEACE"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :requires-pe-entity? true :has-pe-entity? true
             :requires-ruc? true :ruc-verified? true
             :drafted? false :submitted? false
             :jurisdiction "PER" :status :intake}
    "eng-2" {:id "eng-2" :operator "Atlantis LLC" :portal "SEACE"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :requires-pe-entity? true :has-pe-entity? true
             :requires-ruc? true :ruc-verified? true
    ...
    "eng-3" {:id "eng-3" :operator "Minami Systems" :portal "SEACE"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             ...
             :drafted? false :submitted? false
             :jurisdiction "PER" :status :intake}
    "eng-4" {:id "eng-4" :operator "Higashi Export" :portal "SEACE"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :requires-pe-entity? true :has-pe-entity? false
             :requires-ruc? true :ruc-verified? true
             :drafted? false :submitted? false
             :jurisdiction "PER" :status :intake}
    "eng-5" {:id "eng-5" :operator "Nishi Logistics" :portal "SEACE"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :requires-pe-entity? true :has-pe-entity? true
             ...
             :drafted? false :submitted? false
             :jurisdiction "PER" :status :intake}
    "eng-6" {:id "eng-6" :operator "Chuo Civic Tech" :portal "SEACE"
...
(defn- engagement->tx [{:keys [id operator portal base-fee monthly-rate monitoring-months claimed-fee
                               requires-pe-entity? has-pe-entity?
  ...
  (cond-> {:engagement/id id}
    ...
    (some? requires-pe-entity?)  (assoc :engagement/requires-pe-entity? requires-pe-entity?)
    (some? has-pe-entity?)       (assoc :engagement/has-pe-entity? has-pe-entity?)
...
(def ^:private engagement-pull
  [:engagement/id :engagement/operator :engagement/portal :engagement/base-fee :engagement/monthly-rate
   ...
   :engagement/requires-pe-entity? :engagement/has-pe-entity?
...
(defn- pull->engagement [m]
  (when (:engagement/id m)
    {:id (:engagement/id m) :operator (:engagement/operator m) :portal (:engagement/portal m)
     ...
     :requires-pe-entity? (boolean (:engagement/requires-pe-entity? m))
     :has-pe-entity? (boolean (:engagement/has-pe-entity? m))
